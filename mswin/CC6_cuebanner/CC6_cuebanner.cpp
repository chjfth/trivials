...
#include "../../__chjcxx/common-include/include/mswin/JULayout2.h"
...
{
	JULayout *jul = JULayout::EnableJULayout(hdlg, 200, 50);

	jul->AnchorControl(0,0, 50, 0, IDC_EDIT1);
	jul->AnchorControl(50,0, 100, 0, IDC_COMBO1);
...
BOOL Dlg_OnInitDialog(HWND hdlg, HWND hwndFocus, LPARAM lParam) 
{
	...
	_sntprintf_s(textbuf, _TRUNCATE, _T("version: %d.%d.%d"), 
		CC6_cuebanner_VMAJOR, CC6_cuebanner_VMINOR, CC6_cuebanner_VPATCH);
