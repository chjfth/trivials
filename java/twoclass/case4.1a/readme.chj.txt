[2019-09-20]
This Eclipse project shows that "elicsub/src" and "eclisub/test" should be set as <classpathentry>(so-called "Source Folder" in Eclipse IDE, same meaning as env-var CLASSPATH).
