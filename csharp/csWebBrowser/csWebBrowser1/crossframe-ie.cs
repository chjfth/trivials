...
{
    // [2021-03-18] Great thanks to https://stackoverflow.com/a/48254610
    // This class provides a GetDocumentEx() extension method to HtmlWindow class.
    // Purpose:
    // If a webpage PA contains an <iframe> pointing to webpage PB from a *different* domain,
    // PA.Window.Frames[0].Document will throw UnAuthorizedAccessException,
    // while PA.Window.Frames[0].GetDocumentEx() works around this, and we get HtmlDocument object
    // of the targeting iframe.
    ...
    public static class CrossFrameIE
    {
        ...
        public static HtmlDocument GetDocumentEx(this HtmlWindow window)
        {
